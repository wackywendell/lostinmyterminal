...
Let us define an *ordering tuple* to be 
a tuple $$T:\left\{ i\in T\forall i\in\left\{ 1\ldots N \right\} \right\} $$. So 
$$\left(1,2,3 \right)$$ and $$\left(3,1,2,4\right)$$ are *ordering tuples*,
